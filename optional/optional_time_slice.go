...
// on: 2017-10-19 12:56:07.219996956 &#43;0000 UTC
...
func (opt *OptionalTimeSlice) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}

	var unsafeValue Time
...
func (opt OptionalTimeSlice) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
