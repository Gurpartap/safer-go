...
// on: 2017-10-19 10:05:31.179079823 &#43;0000 UTC
...
func (opt _OptionalBytesSlice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *_OptionalBytesSlice) UnmarshalJSON(data []byte) error {
