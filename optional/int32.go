...
// on: 2017-10-19 10:35:50.694581082 &#43;0000 UTC
...
type Int32 interface {
	...
	Some(fn func(value int32)) someInt32Handler

	// None executes the given closure if there is a None value.
	None(fn func())
}

type someInt32Handler interface {
	None(fn func())
}
...
// From performs the conversion.
func (opt *_Int32) From(value int32) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
// This function returns multiple values, and if that's undesirable,
// consider using Some and None functions.
func (opt *_Int32) Unwrap() (int32, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *_Int32) UnwrapOr(def int32) int32 {
	if opt.getHasValue() {
...
// UnwrapOrElse returns the contained value or computes it from a closure.
func (opt *_Int32) UnwrapOrElse(fn func() int32) int32 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
// UnwrapOrPanic returns the contained value or panics.
func (opt *_Int32) UnwrapOrPanic() int32 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
// And returns None if the optional is None, otherwise returns optb.
func (opt *_Int32) And(optb Int32) Int32 {
	if !opt.getHasValue() {
		return opt
	}
	return optb
...
// Or returns the optional if it contains a value, otherwise returns optb.
func (opt *_Int32) Or(optb Int32) Int32 {
	if opt.getHasValue() {
		return opt
	}
	return optb
...
// returns the result.
func (opt *_Int32) OrElse(fn func() Int32) Int32 {
	if opt.getHasValue() {
		return opt
	}
	return fn()
...
// IsSome returns true if the optional is a Some value.
func (opt *_Int32) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *_Int32) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *_Int32) Some(fn func(value int32)) someInt32Handler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return _someInt32Handler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *_Int32) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type _someInt32Handler struct {
	opt *_Int32
}

func (some _someInt32Handler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *_Int32) getHasValue() bool {
	return opt.hasValue
}

func (opt *_Int32) getUnsafeValue() int32 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *_Int32) String() string {
...
func (opt _Int32) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *_Int32) UnmarshalJSON(data []byte) error {
