...
// on: 2017-10-19 12:55:54.772152896 &#43;0000 UTC
...
func (opt *Error) From(value error) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
func (opt *Error) Unwrap() (error, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *Error) UnwrapOr(def error) error {
	if opt.getHasValue() {
...
func (opt *Error) UnwrapOrElse(fn func() error) error {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *Error) UnwrapOrPanic() error {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *Error) And(optb Error) Error {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *Error) Or(optb Error) Error {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *Error) OrElse(fn func() Error) Error {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (some someErrorHandler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *Error) getHasValue() bool {
	return opt.hasValue
}

func (opt *Error) getUnsafeValue() error {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *Error) String() string {
...
func (opt Error) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *Error) UnmarshalJSON(data []byte) error {
...
func (opt *Error) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}
...
func (opt Error) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
