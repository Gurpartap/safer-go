...
// on: 2017-10-19 10:36:05.336139687 &#43;0000 UTC
...
func (opt _OptionalFloat32Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *_OptionalFloat32Slice) UnmarshalJSON(data []byte) error {
