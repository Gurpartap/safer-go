...
// on: 2017-10-19 10:05:26.466272436 &#43;0000 UTC
...
func (opt _OptionalUInt8Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *_OptionalUInt8Slice) UnmarshalJSON(data []byte) error {
