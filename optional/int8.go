...
// on: 2017-10-19 12:55:51.12629481 &#43;0000 UTC
...
func (opt *Int8) Unwrap() (int8, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *Int8) UnwrapOr(def int8) int8 {
	if opt.getHasValue() {
...
func (opt *Int8) UnwrapOrElse(fn func() int8) int8 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *Int8) UnwrapOrPanic() int8 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *Int8) And(optb Int8) Int8 {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *Int8) Or(optb Int8) Int8 {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *Int8) OrElse(fn func() Int8) Int8 {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (opt *Int8) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *Int8) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *Int8) Some(fn func(value int8)) someInt8Handler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return someInt8Handler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *Int8) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type someInt8Handler struct {
	opt *Int8
}

func (some someInt8Handler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *Int8) getHasValue() bool {
	return opt.hasValue
}

func (opt *Int8) getUnsafeValue() int8 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *Int8) String() string {
...
func (opt *Int8) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}
...
func (opt Int8) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
