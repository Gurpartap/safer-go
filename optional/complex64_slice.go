...
// on: 2017-10-19 12:55:58.762379001 &#43;0000 UTC
...
func (opt *Complex64Slice) From(value []complex64) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
func (opt *Complex64Slice) Unwrap() ([]complex64, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *Complex64Slice) UnwrapOr(def []complex64) []complex64 {
	if opt.getHasValue() {
...
func (opt *Complex64Slice) UnwrapOrElse(fn func() []complex64) []complex64 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *Complex64Slice) UnwrapOrPanic() []complex64 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *Complex64Slice) And(optb Complex64Slice) Complex64Slice {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *Complex64Slice) Or(optb Complex64Slice) Complex64Slice {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *Complex64Slice) OrElse(fn func() Complex64Slice) Complex64Slice {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (opt *Complex64Slice) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *Complex64Slice) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *Complex64Slice) Some(fn func(value []complex64)) someComplex64SliceHandler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return someComplex64SliceHandler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *Complex64Slice) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type someComplex64SliceHandler struct {
	opt *Complex64Slice
}

func (some someComplex64SliceHandler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *Complex64Slice) getHasValue() bool {
	return opt.hasValue
}

func (opt *Complex64Slice) getUnsafeValue() []complex64 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *Complex64Slice) String() string {
...
func (opt Complex64Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *Complex64Slice) UnmarshalJSON(data []byte) error {
...
func (opt *Complex64Slice) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}
...
func (opt Complex64Slice) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
