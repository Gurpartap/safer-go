...
// on: 2017-10-19 10:36:02.680469771 &#43;0000 UTC
...
func (opt _OptionalUInt32Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *_OptionalUInt32Slice) UnmarshalJSON(data []byte) error {
