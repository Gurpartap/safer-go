...
// on: 2017-10-19 12:55:56.60650047 &#43;0000 UTC
...
func UInt64SliceFrom(value []uint64, hasValue bool) UInt64Slice {
	opt := &UInt64Slice{}
	if hasValue {
		opt.From(value)
	}
...
func (opt *UInt64Slice) From(value []uint64) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
func (opt *UInt64Slice) Unwrap() ([]uint64, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *UInt64Slice) UnwrapOr(def []uint64) []uint64 {
	if opt.getHasValue() {
...
func (opt *UInt64Slice) UnwrapOrElse(fn func() []uint64) []uint64 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *UInt64Slice) UnwrapOrPanic() []uint64 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *UInt64Slice) And(optb UInt64Slice) UInt64Slice {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *UInt64Slice) Or(optb UInt64Slice) UInt64Slice {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *UInt64Slice) OrElse(fn func() UInt64Slice) UInt64Slice {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (opt *UInt64Slice) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *UInt64Slice) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *UInt64Slice) Some(fn func(value []uint64)) someUInt64SliceHandler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return someUInt64SliceHandler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *UInt64Slice) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type someUInt64SliceHandler struct {
	opt *UInt64Slice
}

func (some someUInt64SliceHandler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *UInt64Slice) getHasValue() bool {
	return opt.hasValue
}

func (opt *UInt64Slice) getUnsafeValue() []uint64 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *UInt64Slice) String() string {
...
func (opt UInt64Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *UInt64Slice) UnmarshalJSON(data []byte) error {
...
func (opt *UInt64Slice) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}
...
func (opt UInt64Slice) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
