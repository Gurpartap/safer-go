...
// on: 2017-10-19 12:55:55.995778017 &#43;0000 UTC
...
func (opt *UInt16Slice) From(value []uint16) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
func (opt *UInt16Slice) Unwrap() ([]uint16, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *UInt16Slice) UnwrapOr(def []uint16) []uint16 {
	if opt.getHasValue() {
...
func (opt *UInt16Slice) UnwrapOrElse(fn func() []uint16) []uint16 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *UInt16Slice) UnwrapOrPanic() []uint16 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *UInt16Slice) And(optb UInt16Slice) UInt16Slice {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *UInt16Slice) Or(optb UInt16Slice) UInt16Slice {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *UInt16Slice) OrElse(fn func() UInt16Slice) UInt16Slice {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (opt *UInt16Slice) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *UInt16Slice) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *UInt16Slice) Some(fn func(value []uint16)) someUInt16SliceHandler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return someUInt16SliceHandler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *UInt16Slice) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type someUInt16SliceHandler struct {
	opt *UInt16Slice
}

func (some someUInt16SliceHandler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *UInt16Slice) getHasValue() bool {
	return opt.hasValue
}

func (opt *UInt16Slice) getUnsafeValue() []uint16 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *UInt16Slice) String() string {
...
func (opt UInt16Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *UInt16Slice) UnmarshalJSON(data []byte) error {
...
func (opt *UInt16Slice) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}

	var unsafeValue []uint16
...
func (opt UInt16Slice) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
