...
// on: 2017-10-19 12:55:53.236492961 &#43;0000 UTC
...
func (opt *Complex128) From(value complex128) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
func (opt *Complex128) Unwrap() (complex128, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *Complex128) UnwrapOr(def complex128) complex128 {
	if opt.getHasValue() {
...
func (opt *Complex128) UnwrapOrElse(fn func() complex128) complex128 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *Complex128) UnwrapOrPanic() complex128 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *Complex128) And(optb Complex128) Complex128 {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *Complex128) Or(optb Complex128) Complex128 {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *Complex128) OrElse(fn func() Complex128) Complex128 {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (opt *Complex128) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *Complex128) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *Complex128) Some(fn func(value complex128)) someComplex128Handler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return someComplex128Handler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *Complex128) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type someComplex128Handler struct {
	opt *Complex128
}

func (some someComplex128Handler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *Complex128) getHasValue() bool {
	return opt.hasValue
}

func (opt *Complex128) getUnsafeValue() complex128 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *Complex128) String() string {
...
func (opt Complex128) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *Complex128) UnmarshalJSON(data []byte) error {
...
func (opt *Complex128) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}
...
func (opt Complex128) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
