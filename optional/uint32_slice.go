...
// on: 2017-10-19 12:55:56.302737039 &#43;0000 UTC
...
func (opt *UInt32Slice) From(value []uint32) {
	opt.unsafeValue = value
	opt.hasValue = true
}
...
func (opt *UInt32Slice) Unwrap() ([]uint32, bool) {
	return opt.getUnsafeValue(), opt.getHasValue()
}

// UnwrapOr returns the contained value or a default.
func (opt *UInt32Slice) UnwrapOr(def []uint32) []uint32 {
	if opt.getHasValue() {
...
func (opt *UInt32Slice) UnwrapOrElse(fn func() []uint32) []uint32 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
	return fn()
...
func (opt *UInt32Slice) UnwrapOrPanic() []uint32 {
	if opt.getHasValue() {
		return opt.getUnsafeValue()
	}
...
func (opt *UInt32Slice) And(optb UInt32Slice) UInt32Slice {
	if !opt.getHasValue() {
		return *opt
	}
	return optb
...
func (opt *UInt32Slice) Or(optb UInt32Slice) UInt32Slice {
	if opt.getHasValue() {
		return *opt
	}
	return optb
...
// returns the result.
func (opt *UInt32Slice) OrElse(fn func() UInt32Slice) UInt32Slice {
	if opt.getHasValue() {
		return *opt
	}
	return fn()
...
func (opt *UInt32Slice) IsSome() bool {
	return opt.getHasValue()
}

// IsNone returns true if the optional is a None value.
func (opt *UInt32Slice) IsNone() bool {
	return !opt.getHasValue()
}

// Some executes the given closure if there is a Some value.
func (opt *UInt32Slice) Some(fn func(value []uint32)) someUInt32SliceHandler {
	if opt.getHasValue() {
		fn(opt.getUnsafeValue())
	}
	return someUInt32SliceHandler{opt: opt}
}

// None executes the given closure if there is a None value.
func (opt *UInt32Slice) None(fn func()) {
	if !opt.getHasValue() {
		fn()
	}
}

type someUInt32SliceHandler struct {
	opt *UInt32Slice
}

func (some someUInt32SliceHandler) None(fn func()) {
	if !some.opt.getHasValue() {
		fn()
	}
}

func (opt *UInt32Slice) getHasValue() bool {
	return opt.hasValue
}

func (opt *UInt32Slice) getUnsafeValue() []uint32 {
	return opt.unsafeValue
}

// String conforms to fmt Stringer interface.
func (opt *UInt32Slice) String() string {
...
func (opt UInt32Slice) MarshalJSON() ([]byte, error) {
	if !opt.getHasValue() {
...
func (opt *UInt32Slice) UnmarshalJSON(data []byte) error {
...
func (opt *UInt32Slice) Scan(value interface{}) error {
	if value == nil {
		opt.Take()
		return nil
	}
...
func (opt UInt32Slice) Value() (driver.Value, error) {
	if !opt.getHasValue() {
		return nil, nil
	}
